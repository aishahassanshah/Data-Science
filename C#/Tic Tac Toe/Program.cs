    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                // After each turn,check if there is a winner and if not ,keep playing
        ...
        {
            // if all markers are in placed and there is no winner then it is a draw stop the game
            if (IsGameDraw(gameMarkers))
            {
                return 2;
            }
            //3.3 if there is a winner,announce who won and stop the game
